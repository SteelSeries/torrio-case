...
cd ..
cd ..
copy "Bootloader\project\at_start_f415\Torrio_Case_Bootloader\iar_v8.2\Torrio_Case_Bootloader_Debug\Exe\Torrio_Case_Bootloader.bin" "App\project\at_start_f415\Torrio_Case_App\iar_v8.2\Torrio_Case_App_Debug\Exe"
cd App
cd project
cd at_start_f415
cd Torrio_Case_App
