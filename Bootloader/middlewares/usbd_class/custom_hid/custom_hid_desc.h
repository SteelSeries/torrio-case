...
/**
  ...
  */
#define USBD_CUSHID_CONFIG_DESC_SIZE     0x5B
...
#define CONSUMER_SIZ_REPORT_DESC (25)
#define SYNCHID_SIZ_REPORT_DESC (30)
...
extern uint8_t g_usbd_configuration[USBD_CUSHID_CONFIG_DESC_SIZE];
extern usbd_desc_handler custom_hid_desc_handler;
extern uint8_t CustomHID_ReportDescriptor[CUSTOMHID_SIZ_REPORT_DESC];
extern uint8_t ConsumerHID_ReportDescriptor[CONSUMER_SIZ_REPORT_DESC];
extern uint8_t SyncHID_ReportDescriptor[SYNCHID_SIZ_REPORT_DESC];
