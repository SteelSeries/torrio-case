...
/**
  ...
  */
  ...
  #pragma data_alignment=4
#endif
uint8_t g_usbd_configuration[USBD_CUSHID_CONFIG_DESC_SIZE] ALIGNED_TAIL =
{
  USB_DEVICE_CFG_DESC_LEN,               /* bLength: configuration descriptor size */
  USB_DESCIPTOR_TYPE_CONFIGURATION,      /* bDescriptorType: configuration */
  LBYTE(USBD_CUSHID_CONFIG_DESC_SIZE),   /* wTotalLength: total length of data returned for this configuration */
  HBYTE(USBD_CUSHID_CONFIG_DESC_SIZE),
  ...
  LBYTE(sizeof(CustomHID_ReportDescriptor)),
  HBYTE(sizeof(CustomHID_ReportDescriptor)), /* wDescriptorLength: total length of reprot descriptor */
  ...
  0x01,                                  /* bNumDescriptors: number of HID class descriptor to follow */
  HID_CLASS_DESC_REPORT,                 /* bDescriptorType: report descriptor type */
  LBYTE(25),                             /* wDescriptorLength: total length of reprot descriptor */
  HBYTE(25),
  ...
  USB_EPT_DESC_INTERRUPT,                /* bmAttributes: endpoint attributes */
  LBYTE(2),
  HBYTE(2),                              /* wMaxPacketSize: maximum packe size this endpoint */
  CUSHID_BINTERVAL_TIME,                 /* bInterval: interval for polling endpoint for data transfers */
  ...
  0x01,                                  /* bNumDescriptors: number of HID class descriptor to follow */
  HID_CLASS_DESC_REPORT,                 /* bDescriptorType: report descriptor type */
  LBYTE(30),                             /* wDescriptorLength: total length of reprot descriptor */
  HBYTE(30),
  ...
  USB_EPT_DESC_INTERRUPT,                /* bmAttributes: endpoint attributes */
  LBYTE(64),                             /* wMaxPacketSize: maximum packe size this endpoint */
  HBYTE(64),
  CUSHID_BINTERVAL_TIME,                 /* bInterval: interval for polling endpoint for data transfers */
...
uint8_t ConsumerHID_ReportDescriptor[CONSUMER_SIZ_REPORT_DESC] =
    {
...
uint8_t SyncHID_ReportDescriptor[SYNCHID_SIZ_REPORT_DESC] =
    {
        0x06, 0xC1, 0xFF, // Usage Page (Vendor-Defined 194)
        0x09, 0x01,       // Usage (Vendor-Defined 1)
        0xa1, 0x01,       // Collection (Application)
